...
def feedback_handler(feedback: str):
    ...
    with open("feedback_log.txt", "a", encoding="utf-8") as f:
        f.write(f"[{timestamp}] User Feedback: {feedback} | Sentiment: {sentiment_label} ({sentiment_score:.2f})\n")

    return f"Thanks for your feedback! Sentiment classified as: {sentiment_label}."
